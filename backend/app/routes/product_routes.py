...
from app.controllers.product_controller import get_all_products, get_product_by_id, create_product, update_product, delete_product, generate_description_api, get_similar_products
...
product_bp.route('/api/products/<int:product_id>/similar', methods=['GET'])(get_similar_products)
