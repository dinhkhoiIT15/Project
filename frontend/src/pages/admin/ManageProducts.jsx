                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-neutral-200">
                      ...
                      <th className="px-4 py-3 text-[11px] font-bold text-neutral-500 uppercase tracking-wider text-right">
                        Actions
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-neutral-200">
                    {products.map((p) => (
                      <tr
                        key={p.product_id}
                        className="hover:bg-neutral-50 transition-colors h-16"
                      >
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={`whitespace-nowrap text-sm font-bold ${p.stock_quantity > 0 ? "text-neutral-700" : "text-red-500"}`}
                          >
                            {p.stock_quantity}
                          </span>
                        </td>
